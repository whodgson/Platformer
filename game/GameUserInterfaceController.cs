...
public class GameUserInterfaceController : MonoBehaviour
{
    ...
    void Initialise()
    {
        ...
        ui_message_box_frame_image_rect.sizeDelta = new Vector2(600, 75);
        ...
        ui_message_box_rect.localPosition = new Vector3(0, -170, 0);
        ui_message_box_rect.sizeDelta = new Vector2(500, 50);
    }
